...
const Login = () => {
    ...
    const [signInCre, setSignInCre] = useState({email:"", password:""})
    ...
    const handleLogin = async (e: React.FormEvent) => {
        e.preventDefault()
        try {
          await login(signInCre.email, signInCre.password)
            navigate('/main')
        } catch (err: any) {
        ...
        <div style={{ width: "100%" }}>
            <form className="form">
                ...
                <div className="inputForm">
                    ...
                    <input   onChange={(e) => setSignInCre({ ...signInCre, email: e.target.value })} 
            type="text" className="input" placeholder="Enter your Email" />
                ...
                <div className="inputForm">
                    ...
                    <input onChange={(e)=>setSignInCre({...signInCre, password:e.target.value})} type={show ? "text" : "password"} className="input" placeholder="Enter your Password" />
                    {show ?
			...
			l50.086-50.086L248.815,373.431z"/>
                ...
                <button className="button-submit" style={{marginTop:"25px"}} onClick={handleLogin}>Sign In</button>
                <p className="p">
                    Don't have an account? <span className="span" onClick={handleNavigate}>Sign Up</span>
                </p>
